package com.example.androidsqlite.Utils;
...
import com.example.androidsqlite.UpdateRecordActivity;
...
public class PersonAdapter extends RecyclerView.Adapter<PersonAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        //Picasso(mContext).load(person.getImage()).placeholder(R.mipmap.ic_launcher).into(holder.personImageImgV);
